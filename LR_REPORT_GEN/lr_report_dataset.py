### CONNECTS TO THE DATABASE AND QUERIES FOR DATA ###
### THIS AWS_DATA.JSON IS NECESSARY FOR CONFIGURATION ###
...
cursor =  connect(aws_access_key_id=aws_data["aws_access"]["access_key_id"],
                  ...
                  region_name=aws_data["aws_access"]["region"]).cursor()
...
## QUERIES ##
sample_query = 'SELECT ninety_percent FROM another.resdata WHERE pass > 500'
...
fetch = cursor.execute(sample_query).fetchall()
